...
This module defines the Game entity with relationships to Publisher and Category,
...
class Game(BaseModel):
    ...
    def to_dict(self):
        ...
        Returns:
            dict: A dictionary containing game data with nested publisher and category objects
        """
        return {
            'id': self.id,
            'title': self.title,
